...
class CaseActivity(models.Model):
    ...
    activity = fields.RichTextField(blank=True, default="",
             help_text=_("Describe the activity tasks relevant to the case story provided. These could be in the form of questions or instructions for activity which may lead the learner to resolving a dilemma presented. "))
