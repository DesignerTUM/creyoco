...
require(['jquery', 'jquery-jsonrpc', 'eyecandy', 'dragula'], function ($, _, eyecandy, dragula) {

    $(document).ready(function () {
        // fade out the error message
        $('#error_messages').delay(5000).fadeOut();

        dragula([document.getElementById('package_list')], {
    ...
    function drag_package(package_id, position, drag_el){
        $.jsonRPC.request('drag_package',{
            params: [package_id, undefined, position],
