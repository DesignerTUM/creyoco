...
//        Initialize idevice Tree
    ...
    function promote_current_node() {
        ...
        $.jsonRPC.request('promote_current_node', [get_package_id(), common.get_current_node_id()], {
            success: function (results) {
    ...
    function move_current_node_up() {
        ...
        $.jsonRPC.request('move_current_node_up', [get_package_id(), common.get_current_node_id()], {
