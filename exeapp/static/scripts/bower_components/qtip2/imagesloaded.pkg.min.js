...
(function (t) {
    ...
    function s(t) {
        var e = [];
        if (i(t))e = t; else if ("number" == typeof t.length)for (var s = 0, o = t.length; o > s; s++)e.push(t[s]); else e.push(t);
        return e
    }
    ...
    function o(t, i) {
        function o(t, i, r) {
            ...
            "string" == typeof t && (t = document.querySelectorAll(t)), this.elements = s(t), this.options = e({}, this.options), "function" == typeof i ? r = i : e(this.options, i), r && this.on("always", r), this.getImages(), n && (this.jqDeferred = new n.Deferred);
            var a = this;
            setTimeout(function () {
                a.check()
            })
        ...
        o.prototype = new t, o.prototype.options = {}, o.prototype.getImages = function () {
            ...
            for (var t = 0, e = this.elements.length; e > t; t++) {
                ...
                for (var s = i.querySelectorAll("img"), o = 0, n = s.length; n > o; o++) {
                    var r = s[o];
                    this.addImage(r)
                }
            }
            ...
            function t(t, o) {
                return e.options.debug && a && r.log("confirm", t, o), e.progress(t), i++, i === s && e.complete(), !0
            }

            var e = this, i = 0, s = this.images.length;
            if (this.hasAnyBroken = !1, !s)return this.complete(), void 0;
            for (var o = 0; s > o; o++) {
                var n = this.images[o];
        ...
        return h.prototype = new t, h.prototype.check = function () {
            ...
            if (l[this.img.src] = this, this.img.complete && void 0 !== this.img.naturalWidth)return this.confirm(0 !== this.img.naturalWidth, "naturalWidth"), void 0;
            var e = this.proxyImage = new Image;
            i.bind(e, "load", this), i.bind(e, "error", this), e.src = this.img.src
        }, h.prototype.useCached = function (t) {
    ...
    var n = t.jQuery, r = t.console, a = r !== void 0, h = Object.prototype.toString;
